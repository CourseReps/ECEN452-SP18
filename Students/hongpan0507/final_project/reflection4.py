...
for i in range(0, len(ratio_T1_T2)):
    ...
    for k in range(0, len(z_T1)):
        ...
        for j in range(0, len(c)):
            ...
            z_temp = (1/z_temp + 1/z_p + 1/z_r)**-1     # in parallel with C_p
...
for j in range(0, len(ratio_T1_T2)):
    ...
    for i in range(0, len(z_T1)):
        ...
        plot.plot(c, gamma_ang4[j][i], '*', label="z_T1 = " + str(z_T1[i]) + "; z_T1/z_T2 = " + str(ratio_T1_T2[j]) + "; z_T2 = " + str(z_T1[i]/ratio_T1_T2[j]))
