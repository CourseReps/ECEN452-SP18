...
with open('ECEN_452_Plotting_s11.csv') as csvfile:
...
ax1.plot(x, y1, '-b', label="HFSS") #plot y1 vs. x, solid-blue, add lable for legend
ax1.plot(x, y2, '-r', label="Analytic") #plot y2 vs. x, solid-red, add lable for legend
ax1.plot(x, y3, '--r', label="Z0lver") #plot y3 vs. x, dashed-red, add lable for legend
...
plt.title('S21 in dB') #add plot title
