...
with open('MK_HI_90deg.csv') as csvfile:
    ...
    for row in reader:
        ...
        y1.append(float(row['11 90']))
        y2.append(float(row['11 180']))
        y3.append(float(row['11 Thru']))
        y4.append(float(row['11 Thru2']))
...
plt.title('S11 Phase Shifter Measurements') #add plot title
