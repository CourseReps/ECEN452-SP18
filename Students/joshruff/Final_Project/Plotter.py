...
L = 1.5e-9#Inductance of lumped inductor or stub
w = 2*mmm.pi*2.45e9#Range of frequencies 

###QWT Values
Z01 = 30 #Lower than Z02 ###Second Quarter-Wave Transformer
Z02 = 20###First Quarter Wave Transformer
#10 pF constant
...
#	X.append(complex(0,w*L-1/(w*C[i])))#Lossless
