...
with open('Phase_Shifter_S11_Magnitude.csv') as csvfile:
...
ax1.plot(Freq, Thru, '-r', label="Thru Data") #plot y2 vs. x, solid-red, add lable for legend
ax1.plot(Freq, S180, '-r', label="180 Phase Data") #plot y2 vs. x, solid-red, add lable for legend
ax1.plot(Freq, S90, '-r', label="90 Phase Data") #plot y2 vs. x, solid-red, add lable for legend
...
plt.title('Phase Shifter S11') #add plot title
