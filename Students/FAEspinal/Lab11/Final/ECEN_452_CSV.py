...
with open('S21_Thru.csv') as csvfile:
...
ax1.plot(Freq, Thru, '-b', label="Thru Data") #plot y1 vs. x, solid-blue, add lable for legend
...
plt.title('GRL Calibration (S21 Log Mag') #add plot title
